...
(function (window, document, undefined) {
  ...
  function da(a) {
    ...
    if (a.c.indexOf("Version/") != -1) {
      ...
      if (d != "")
        return new y("Opera", d, b, c, A(a), D(a), E(a, a.k), F(a, d) >= 10);
    }
    d = C(a, a.c, /Opera[\/ ]([\d\.]+)/, 1);
    if (d != "")
      return new y("Opera", d, b, c, A(a), D(a), E(a, a.k), F(a, d) >= 10);
  ...
  V.prototype.J = function () {
    ...
    if ((this.O != a || this.P != b) && !this.t[a] && !this.t[b])
      ...
      this.t[a] && this.t[b] && xa[this.L] ? Q(this, this.H) : Q(this, this.$);
    else qa(this);
  };
  function ya(a) {
    this.I = a
  ...
  X.prototype.load = function (a) {
    for (
      var b = this.d.urls || [], c = this.d.families || [], d = 0, e = b.length;
      d < e;
      d++
    )
    ...
    if (a) {
      ...
      this.m.__webfontfontdeckmodule__[a] = function (d, e) {
        for (var f = 0, g = e.fonts.length; f < g; ++f) {
          ...
          c.f.push(h.name);
          c.s[h.name] = [
            c.v.compact("font-weight:" + h.weight + ";font-style:" + h.style),
          ];
        }
        b(d);
      };
  ...
  Z.prototype.protocol = function () {
    ...
    if (this.k && this.k.location && this.k.location.protocol) {
      ...
      for (c = 0; c < a.length; c++)
        if (this.k.location.protocol === a[c]) return this.k.location.protocol;
    }
    return b;
  };
