  ...
  $.extend(SVGWrapper.prototype, {
    ...
    script: function (a, b, c, d) {
      ...
      var f = this._makeNode(
        e.parent,
        "script",
        $.extend({ type: e.type || "text/javascript" }, e.settings || {})
      );
    ...
    radialGradient: function (a, b, c, d, e, r, f, g, h) {
      ...
      var j = $.extend(
        { id: i.id },
        i.cx != null ? { cx: i.cx, cy: i.cy, r: i.r, fx: i.fx, fy: i.fy } : {}
      );
      return this._gradient(
        i.parent,
        "radialGradient",
    ...
    path: function (a, b, c) {
      ...
      return this._makeNode(
        d.parent,
        "path",
        $.extend({ d: d.path.path ? d.path.path() : d.path }, d.settings || {})
      );
    },
    ...
    ellipse: function (a, b, c, d, e, f) {
      ...
      return this._makeNode(
        g.parent,
        "ellipse",
        $.extend({ cx: g.cx, cy: g.cy, rx: g.rx, ry: g.ry }, g.settings || {})
      );
    },
    line: function (a, b, c, d, e, f) {
      ...
      return this._makeNode(
        g.parent,
        "line",
        $.extend({ x1: g.x1, y1: g.y1, x2: g.x2, y2: g.y2 }, g.settings || {})
      );
    },
